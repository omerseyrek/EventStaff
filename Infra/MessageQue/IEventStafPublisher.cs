...
namespace EventStaf.Infra.MessageQue
{
    ...
    public class EventStafPublisher : MessagePublisher, IEventStafPublisher
	{
		private readonly IPublishEndpoint _publishEndpoint2;

		public EventStafPublisher(IPublishEndpoint publishEndpoint) : base(publishEndpoint)
		{
			_publishEndpoint2 = publishEndpoint;
		}
